...
class MotorGui(Node):
    ...
    def __init__(self):
        ...
        Button(motor_btns_frame, text='Send Cont.', command=self.start_cont_send).pack(side=LEFT)
        Button(motor_btns_frame, text='Stop Send', command=self.stop_cont_send).pack(side=LEFT)
        ...
        # Initialize state variables for continuous sending
        self.cont_send = False
