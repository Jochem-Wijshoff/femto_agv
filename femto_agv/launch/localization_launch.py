...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('femto_agv')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map', default_value=os.path.join(bringup_dir, 'map', 'pid_map.yaml'), description='Full path to map yaml file to load'
    )
